...
const I18N = {
    ...
    es: {
        ...
        form: { nameLabel:'Nombre *', emailLabel:'Email *', aboutLabel:'Resumen del proyecto *', aboutPh:'Objetivo, plataforma(s), features clave, plazos', budgetLabel:'Presupuesto', budget0:'Sin definir', timelineLabel:'Plazos', timeline0:'Flexibles', timeline1:'Hasta 1 mes', timeline2:'1–3 meses', timeline3:'3–6 meses', timeline4:'6+ meses', submit:'Enviar', note:'Al enviar aceptás el tratamiento de tus datos para responder tu solicitud.' },
    ...
    pt: {
        ...
        form: { nameLabel:'Nome *', emailLabel:'Email *', aboutLabel:'Resumo do projeto *', aboutPh:'Objetivo, plataforma(s), features-chave, prazos', budgetLabel:'Orçamento', budget0:'Indefinido', timelineLabel:'Prazo', timeline0:'Flexível', timeline1:'Até 1 mês', timeline2:'1–3 meses', timeline3:'3–6 meses', timeline4:'6+ meses', submit:'Enviar', note:'Ao enviar, você concorda com o tratamento dos seus dados para resposta ao seu pedido.' },
    ...
    ru: {
        ...
        form: { nameLabel:'Имя *', emailLabel:'Email *', aboutLabel:'Кратко о проекте *', aboutPh:'Цель, платформа(ы), ключевые фичи, сроки', budgetLabel:'Бюджет', budget0:'Не определён', timelineLabel:'Сроки', timeline0:'Гибкие', timeline1:'До 1 месяца', timeline2:'1–3 месяца', timeline3:'3–6 месяцев', timeline4:'6+ месяцев', submit:'Отправить', note:'Нажимая «Отправить», вы соглашаетесь на обработку данных для ответа на ваш запрос.' },
